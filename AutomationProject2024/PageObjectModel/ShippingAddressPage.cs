...
namespace AutomationProject2024.PageObjectModel
{
    public class ShippingAddressPage
    {
        ...
        public void AddingDataIntoShippingForm()
        {
            ...
            Thread.Sleep(200);
            wait.Until(driver => ConfirmButton.Displayed && ConfirmButton.Enabled);
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                termsButton = _driver.FindElement(By.XPath("//*[@id=\"option_agree\"]"));
                Thread.Sleep(100);
                ((IJavaScriptExecutor)_driver).ExecuteScript("arguments[0].click();", termsButton);
                Thread.Sleep(500);
